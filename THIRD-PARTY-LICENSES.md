...
The optional `[crawl]` extra (`crawl4ai` + Playwright, for JavaScript-rendered crawling) pulls in a much larger tree and is **not** installed by default or included in the Docker image.
